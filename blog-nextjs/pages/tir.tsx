...
const Tir = () => (
  <>
    ...
    <div className="tw-py-20 tw-mx-auto tw-max-w-3xl tw-px-4">
      <div className="tw-text-center">
        <picture>
          <source type="image/webp" srcSet="/images/tir.webp" />
          <source type="image/jpeg" srcSet="/images/tir.png" />
          <img className="md:tw-w-[50%] tw-mx-auto" alt="Cover of a book: Debug your time in range - The 6-week course for diabetic developers to increase TIR by 10%" src="/images/tir.png" />
        </picture>
      </div>

      <h1 className="tw-text-4xl tw-font-semibold tw-mb-4 tw-leading-7 tw-mt-32">
        Debug your time in range
        <br />
        <span className="tw-text-xl tw-text-gray-500">The 6-week course for diabetic developers to increase TIR by 10%</span>
      </h1>

      <p className="tw-mt-10">
      This is also available as a <Link href="https://tir.odone.io"><a target="_blank" rel="noopener" className="tw-underline tw-text-[color:var(--blue)]">six-week email course</a></Link>.
      </p>

      <h2 className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Table of content
      </h2>

      <ul className="tw-list-none tw-p-0">
        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-0">
            The first step to 10% more Time In Range
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-1">
            Tip #1: 100% basal insulin coverage
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-2">
            Tip #2: TDD your blood sugars
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-3">
            Tip #3: Remove <code>if</code>s from your diabetes management
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-4">
            Tip #4: Bolusing is an impure function of timing and amount
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-5">
            Tip #5: The KISS way to highs and lows
          </a>
        </li>

        <li>
          <a className="tw-underline tw-text-[color:var(--blue)]" href="#tip-6">
            Tip #6: This is how I do it
          </a>
        </li>
      </ul>

      <h2 id="tip-0" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        The first step to 10% more Time In Range
      </h2>
      ...
      <p className="tw-mb-4">
      Please duplicate the <Link href="https://docs.google.com/spreadsheets/d/1agCSjgpFGCDfFSUt15aS5d9t3Voaqvf8qpk-Ri8m1AQ/edit?usp=sharing"><a className="tw-underline tw-text-[color:var(--blue)]" target="_blank" rel="noopener">spreadsheet</a></Link> you will use to track your 10% time in range increase in six weeks.
      </p>
      ...
      <div className="tw-text-center">
        <iframe className="tw-mx-auto" width="560" height="315" src="https://www.youtube.com/embed/heIyhPhwqFY" title="YouTube: The Spreadsheet" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
      ...
      <h2 id="tip-1" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #1: 100% basal insulin coverage
      </h2>
      ...
      <p className="tw-mt-10">
      <span className="tw-italic">But how the hell do I fine tune my basal with all the variables that affect my blood sugars?</span> You test drive it—think unit testing where the unit under test is your basal insulin.
      </p>

      <p className="tw-mb-4">
      Take an average day, be in a fasting state, drink only water, and measure your blood sugars every hour. You want your basal to keep your blood sugars in a flatline plus or minus a small variation (20-30 mg/dl). Here&apos;s a more in depth <Link href="https://integrateddiabetes.com/basal-testing/"><a className="tw-underline tw-text-[color:var(--blue)]" target="_blank" rel="noopener">explanation</a></Link>.
      </p>
      ...
      <h2 id="tip-2" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #2: TDD your blood sugars
      </h2>
      ...
      <p className="tw-mb-4">
      At the end of your day, jump into the <Link href="https://docs.google.com/spreadsheets/d/1agCSjgpFGCDfFSUt15aS5d9t3Voaqvf8qpk-Ri8m1AQ/edit?usp=sharing"><a className="tw-underline tw-text-[color:var(--blue)]" target="_blank" rel="noopener">Today sheet</a></Link>, fill in your readings, and focus on one or two surprising blood sugars: what can you do tomorrow to improve them? 
      </p>
      ...
      <div className="tw-text-center">
        <iframe className="tw-mx-auto" width="560" height="315" src="https://www.youtube.com/embed/1o3rTq6tAQA" title="YouTube: Daily Review" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
      ...
      <h2 id="tip-3" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #3: Remove <code>if</code>s from your diabetes management
      </h2>
      ...
      <h2 id="tip-4" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #4: Bolusing is an impure function of timing and amount
      </h2>
      ...
      <p className="tw-mb-4">
      You can use the <Link href="https://waltzingthedragon.ca/diabetes/nutrition-excercise/reduce-post-meal-spikes-caused-by-fat-and-protein/"><a className="tw-underline tw-text-[color:var(--blue)]" target="_blank" rel="noopener">Warsaw approach</a></Link> as a starting point. But, as a general rule, you cover proteins and fats with an extended bolus.
      </p>
      ...
      <p className="tw-pl-5 tw-border-gray-400 tw-text-gray-400" style={{ borderLeft: '4px solid' }}>
      ...
      <h2 id="tip-5" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #5: The KISS way to highs and lows
      </h2>
      ...
      <p className="tw-mt-10">
      <span className="tw-font-bold">The best way to handle a number out-of-range is not to get there in the first place</span>. And to do that you need one thing: flatten the curves.
      </p>
      ...
      <h2 id="tip-6" className="tw-mt-32 tw-mb-5 tw-text-2xl tw-uppercase tw-text-center">
        Tip #6: This is how I do it
      </h2>
      ...
      <div className="tw-text-center">
        <iframe className="tw-mx-auto" width="560" height="315" src="https://www.youtube.com/embed/OoR5lnyMyK4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>

      <div className="tw-mt-32 tw-text-center">
        <picture>
          <source type="image/webp" srcSet="/images/tir-back.webp" />
          <source type="image/jpeg" srcSet="/images/tir-back.png" />
          <img className="md:tw-w-[50%] tw-mx-auto" alt="Backcover of the book: You are never alone inside a blue circle" src="/images/tir-back.png" />
        </picture>
      </div>

      <div className="tw-mt-32 tw-text-gray-500">
        <p className="tw-mb-4">
