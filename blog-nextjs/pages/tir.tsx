...
const Tir = () => (
  <>
    ...
    <div className="tw-py-20 col-sm-8 col-md-8 col-lg-6 mx-auto">
      <div className="tw-text-center">
        <picture>
          <source type="image/webp" srcSet="/images/tir.webp" />
          <source type="image/jpeg" srcSet="/images/tir.png" />
          <img className="md:tw-w-[50%]" alt="Cover of a book: Debug your time in range - The 6-week course for diabetic developers to increase TIR by 10%" src="/images/tir.png" />
        </picture>
      </div>

      <h1 className="tw-text-4xl tw-mt-32 tw-mb-0 tw-leading-7">
      ...
      This is also available as a <Link href="https://tir.odone.io"><a target="_blank" rel="noopener">six-week email course</a></Link>.
      </p>
      ...
      <p>
      Please duplicate the <Link href="https://docs.google.com/spreadsheets/d/1agCSjgpFGCDfFSUt15aS5d9t3Voaqvf8qpk-Ri8m1AQ/edit?usp=sharing"><a target="_blank" rel="noopener">spreadsheet</a></Link> you will use to track your 10% time in range increase in six weeks.
      </p>
      ...
      <div className="tw-text-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/heIyhPhwqFY" title="YouTube: The Spreadsheet" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
      ...
      <p>
      At the end of your day, jump into the <Link href="https://docs.google.com/spreadsheets/d/1agCSjgpFGCDfFSUt15aS5d9t3Voaqvf8qpk-Ri8m1AQ/edit?usp=sharing"><a target="_blank" rel="noopener">Today sheet</a></Link>, fill in your readings, and focus on one or two surprising blood sugars: what can you do tomorrow to improve them? 
      </p>
      ...
      <div className="tw-text-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/1o3rTq6tAQA" title="YouTube: Daily Review" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
      ...
      <p>
      You can use the <Link href="https://waltzingthedragon.ca/diabetes/nutrition-excercise/reduce-post-meal-spikes-caused-by-fat-and-protein/"><a target="_blank" rel="noopener">Warsaw approach</a></Link> as a starting point. But, as a general rule, you cover proteins and fats with an extended bolus.
      </p>
      ...
      <div className="tw-text-center">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/OoR5lnyMyK4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      </div>
      ...
      <div className="tw-mt-32 tw-text-center">
        <picture>
          ...
          <img className="md:tw-w-[50%]" alt="Backcover of the book: You are never alone inside a blue circle" src="/images/tir-back.png" />
        </picture>
      </div>
