...
- small valuable iterations like we did for [AirCasting](/posts/2020-07-13-elm-tricks-from-production–migrating-from-angular-v1-to-elm/).

I've personally worked in Ruby and JavaScript for a long time and the only [real contribution](/posts/2019-08-26-building-a-blog-in-haskell-with-yesod–giving-back/) I made to OSS was to Yesod 😅
